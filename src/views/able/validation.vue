  ...
  <el-card class="clo-center">
    ...
    <div className="sliderContent">
      <div className="imgDev" style="width: 500px">
        ...
        <canvas className="slider" id="sliderBlock" :width="sliderWidth" :height="sliderHeight" :style="{ left: sildLeft }"></canvas>
      </div>
    </div>
  </el-card>
</template>
...
const sliderWidth = ref(32);
const sliderHeight = ref(32);
...
// https://www.jianshu.com/p/7feaf0aaacbf
</script>
