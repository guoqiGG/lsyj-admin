<template>
  <el-card shadow="never" class="henader-card">
    <div class="flx-row">
      <el-form :inline="true" :model="queryData" style="flex: 1">
        ...
        <el-date-picker class="ml20" v-model="queryData.date" type="datetimerange" :shortcuts="shortcuts" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" />
      </el-form>
  ...
  <el-dialog v-model="dialogVisible" :title="`${dialogData.title}用户`" :width="dialogWidth" :hide-required-asterisk="dialogData.isView" draggable>
...
<script setup>
import { Search, Edit, Delete, UserFilled, InfoFilled } from "@element-plus/icons-vue";
import { getUserList, addUserList, listUpdate } from "../../../api/modules/index.js";
